...
export class Client extends EObject {
    ...
    * 
    ...
    private setupWebRTC() {
        ...
        //this.stub.importRemoteFunction(_this.webRTCProxy, _this.socket, jobj[Protocol.contractId]);
    }
    ...
    private _handleClient(client, proxy) {
        ...
        client.on('message', function (data) {
            ...
            if (jobj[Protocol.contractId]) //should be first message
            {
                var update = __this.contract && __this.contract.length > 0;

                __this.contract = jobj[Protocol.contractId];
                ...
                __this.stub.importRemoteFunction(proxy, client, jobj[Protocol.contractId]/*, _this.serialize*/);
            ...
            if (jobj[Protocol.functionId] !== undefined) //server invoking client
            {
                ...
                if (client.context == undefined) {
                    ...
                    client.context = { 
                        ...
                        async: false, 
                        retId: jobj[Protocol.signatureId], 
                        serialize:__this.serialize,
                        'return': returnFunc };
                }
                client.context.retId = jobj[Protocol.signatureId];
                ...
                //          console.log('hello');
                //    }
                //if (jobj[Protocol.context]) {
                //    client.remoteContext = jobj[Protocol.context];
                //}
