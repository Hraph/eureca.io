    ...
    * }
    ...
    public updateContract() {
        ...
        for (var id in this.clients) {
            ...
            var sendObj = {};
            sendObj[Protocol.contractId] = this.contract;
    ...
    private _handleServer(ioServer:IServer)
    {
        ...
        ioServer.onconnect(function (eurecaClientSocket) {
            ...
            var sendContract = function () {
                ...
                var sendObj = {};
                sendObj[Protocol.contractId] = __this.contract;

                if (__this.allowedF == 'all')
                    sendObj[Protocol.signatureId] = eurecaClientSocket.id;
            ...
            eurecaClientSocket.on('message', function (message) {
                ...
                */
                ...
                if (jobj[Protocol.authReq] !== undefined) {
                    ...
                    {
                        var args = jobj[Protocol.authReq];
